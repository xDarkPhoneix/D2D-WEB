    ...
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-4">
            ...
            <div className="leading-tight">
              <h2 className="text-xl font-bold tracking-widest text-white">SOCIAL</h2>
              <h2 className="text-xl font-bold tracking-widest text-white">STUDIO</h2>
            </div>
          </div>

          <div className="flex flex-col items-center md:items-end">
            <p className="text-xs uppercase tracking-wider mb-2 font-semibold text-white/80">d2d YOUTHSTORY PVT. LTD. supported by:-</p>
            <div className="flex flex-wrap justify-center gap-2">
              {supportedBy.map((partner, idx) => (
                <span key={idx} className="bg-white text-black text-[10px] font-bold px-2 py-1 rounded shadow-sm">
                  {partner}
                </span>
              ))}
            </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-16 space-y-16">
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h1 className="text-6xl font-bold text-white mb-8 border-l-8 border-green-500 pl-6">
              <span className="text-green-400">Privacy</span> <span className="text-green-200">Policy:</span>
            </h1>
            <p className="text-lg text-gray-300 leading-relaxed">
              At <span className="font-bold text-white">D2D Social Studio</span>, we respect your privacy and are committed to protecting any information you share with us. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.
            </p>
          </div>
        ...
        <section className="bg-gray-900/50 p-8 rounded-2xl border-l-4 border-orange-500">
          ...
          <p className="text-gray-300 leading-relaxed mb-4">
            We may collect personal information such as your name, email address, or phone number <span className="text-white font-bold">only when you choose to share it</span>, for example through contact forms or inquiries.
          </p>
        ...
        <section className="space-y-8">
          <div className="bg-gray-900/50 p-8 rounded-2xl border-l-4 border-blue-500">
          ...
          <div>
            <h2 className="text-3xl font-bold text-white mb-6">Your Data Protection Rights (GDPR)</h2>
            <p className="text-gray-300 mb-6">You have certain rights under the General Data Protection Regulation (GDPR). These rights are designed to give you control over your personal data.</p>
        ...
        <section className="bg-gradient-to-r from-orange-600 to-orange-800 p-8 rounded-2xl text-center">
          ...
          <p className="text-white/90 mb-8 italic">
