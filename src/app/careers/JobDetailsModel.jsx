    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
        <div className="bg-white w-full max-w-4xl max-h-[90vh] overflow-y-auto rounded-2xl p-8 relative shadow-xl">
          ...
          <p className="text-gray-600 mb-6">Permanent • Brand Solutions</p>

          {/* ABOUT */}
          <h2 className="text-xl font-semibold mb-2">About Social Panga</h2>
          <p className="text-gray-700 mb-6">
            Social Panga is a creative digital marketing agency that specializes
            in crafting innovative and impactful campaigns for brands. We
            believe in the power of storytelling, data-driven strategies, and
            creative excellence to deliver results that matter.
          </p>

          {/* POSITION OVERVIEW */}
          <h2 className="text-xl font-semibold mb-2">Position Overview</h2>
          <p className="text-gray-700 mb-6">
