...
export default function Header() {
  ...
  const notifications = [
    { id: 1, text: 'New service request from Nike Inc.', time: '2h ago', unread: true },
    { id: 2, text: 'Application received for Creative Designer', time: '5h ago', unread: true },
    { id: 3, text: 'Service approved for TechCorp', time: '1d ago', unread: false },
  ];
